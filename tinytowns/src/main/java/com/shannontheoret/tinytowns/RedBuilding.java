...
public class RedBuilding extends Building {
    ...
    public RedBuilding(Piece resourceA, Piece resourceB, Piece resourceC, Piece resourceD) {
    ...
    private void generateOrientations() {
        ...
        cubes.put(new RelativePosition(1,1), resourceD);
        cubeOrientations.add(cubes);

        Map<RelativePosition, Piece> cubesMirrorX = new HashMap<>();
        cubesMirrorX.put(new RelativePosition(1,0), resourceA);
        cubesMirrorX.put(new RelativePosition(0,0), resourceB);
        ...
        cubesMirrorY.put(new RelativePosition(0,1), resourceA);
        cubesMirrorY.put(new RelativePosition(1,1), resourceB);
        cubesMirrorY.put(new RelativePosition(0,0), resourceC);
        cubesMirrorY.put(new RelativePosition(1,0), resourceD);
        cubeOrientations.add(cubesMirrorY);

        Map<RelativePosition, Piece> cubes90 = new HashMap<>();
        cubes90.put(new RelativePosition(1,0), resourceA);
        cubes90.put(new RelativePosition(1,1), resourceB);
        cubes90.put(new RelativePosition(0,0), resourceC);
        cubes90.put(new RelativePosition(0,1), resourceD);
        cubeOrientations.add(cubes90);

        Map<RelativePosition, Piece> cubes90MirrorX = new HashMap<>();
        cubes90MirrorX.put(new RelativePosition(0,0), resourceA);
        cubes90MirrorX.put(new RelativePosition(0,1), resourceB);
        cubes90MirrorX.put(new RelativePosition(1,0), resourceC);
        cubes90MirrorX.put(new RelativePosition(1,1), resourceD);
        cubeOrientations.add(cubes90MirrorX);

        Map<RelativePosition, Piece> cubes90MirrorY = new HashMap<>();
        cubes90MirrorY.put(new RelativePosition(1,1), resourceA);
        cubes90MirrorY.put(new RelativePosition(1,0), resourceB);
        ...
        cubes180.put(new RelativePosition(0,1), resourceB);
        cubes180.put(new RelativePosition(1,0), resourceC);
        cubes180.put(new RelativePosition(0,0), resourceD);
